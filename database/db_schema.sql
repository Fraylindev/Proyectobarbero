...
-- Establecer rol de admin para el profesional principal
UPDATE professionals 
...
INSERT INTO professionals (name, specialty, description, phone, email, username, password_hash, role) VALUES
    ('Admin Barbershop', 
     ...
     'admin@example.com',
     'admin',
     '$2b$10$bIPk7Cn1TuQRUtgx1zrY0.M6YQzisnogEIaPaMDKhGeJtRzpeStU2', -- Reemplazar con hash real para 'admin123'
     'PROFESSIONAL_ADMIN');
    ...
    ('Profesional Test', 
     ...
     'Experiencia en cortes modernos y clásicos',
     '18092659874',
     'profesional@example.com',
     'profesional',
     '$2b$10$0QI4j966RcH/6gG41ZLSVe1V6YMM9v55aTeC2k8sosg6lnOhvEX.K', -- Reemplazar con hash real
     'PROFESSIONAL');
